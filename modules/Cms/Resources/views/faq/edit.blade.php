                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-gray-dark card-outline">
                        <div class="card-header">
                            <h3 class="card-title mt-1">Edit Faq</h3>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input id="question" name="question" value="{{ old('question') ?: $faq->question }}" type="text" class="form-control @error('question') is-invalid @enderror" placeholder="Enter question" autofocus>
                                            @error('question')
									...
									<div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="description" name="answer" class="form-control" rows="3" placeholder="Enter answer">{{ old('answer') ?: $faq->answer }}</textarea>
                                            @error('answer')
                                            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                            @enderror
                                        </div>
