                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-gray-dark card-outline">
                        <div class="card-header">
                            <h3 class="card-title mt-1">Create Content</h3>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="content_category_id" name="content_category_id" class="form-control  @error('content_category_id') is-invalid @enderror">
                                                ...
                                                @foreach($contentCategories as $contentCategory)
                                                    <option value="{{ $contentCategory->id }}" {{ old('content_category_id') ? (old('content_category_id') == $contentCategory->id ? 'selected' : '') : '' }}>{{ $contentCategory->title }}</option>
                                                @endforeach
                                            </select>
