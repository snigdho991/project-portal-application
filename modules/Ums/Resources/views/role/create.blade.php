                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select id="permissions" name="permissions[]"
                                                class="form-control select2 @error('permissions') is-invalid @enderror" data-placeholder="Select Permissions" multiple>
