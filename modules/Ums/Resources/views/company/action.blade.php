<div class="btn-group">
    <a href="{{ route('backend.ums.company.show', [$data->id]) }}" type="button" class="btn btn-default">
        <i class="fas fa-eye"></i>
    </a>
    <a href="{{ route('backend.ums.company.edit', [$data->id]) }}" type="button" class="btn btn-default">
    ...
    {!! Form::open(['url' => route('backend.ums.company.destroy', [$data->id]), 'method' => 'delete', 'id' => 'delete_form' . $data->id]) !!}{!! Form::close() !!}
</div>
