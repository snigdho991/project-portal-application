            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card card-gray-dark card-outline">
                        ...
                        {!! Form::open(['url' => route('backend.ums.user-social-account.update', [$userSocialAccount->id]), 'method' => 'put', 'files' => true]) !!}
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="username" class="@error('username') text-danger @enderror">Social Site Username</label>
                                            <input id="username" name="username" value="{{ old('username') ?: $userSocialAccount->username }}" type="text" class="form-control @error('username') is-invalid @enderror" placeholder="Enter social site username" autofocus>
                                            @error('username')
									...
									<div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input id="social_site_id" name="social_site_id" value="{{ old('social_site_id') ?: $userSocialAccount->social_site_id }}" type="text" class="form-control @error('social_site_id') is-invalid @enderror" placeholder="Enter social site id" autofocus>
